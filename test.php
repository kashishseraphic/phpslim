...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, $baseUrl . '/books');
curl_setopt($ch, CURLOPT_POST, true);
...
if (isset($bookId)) {
    ...
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, $baseUrl . "/books/$bookId/borrow");
    curl_setopt($ch, CURLOPT_POST, true);
...
if (isset($bookId)) {
    ...
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, $baseUrl . "/books/$bookId/borrows");
    curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
    curl_setopt($ch, CURLOPT_HTTPHEADER, [
        'Authorization: Bearer ' . $accessToken
    ]);
...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, $baseUrl . '/analytics/latest-borrow-per-book');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
curl_setopt($ch, CURLOPT_HTTPHEADER, [
    'Authorization: Bearer ' . $accessToken
]);
...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, $baseUrl . '/analytics/book-summary');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
curl_setopt($ch, CURLOPT_HTTPHEADER, [
    'Authorization: Bearer ' . $accessToken
]);
...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, $baseUrl . '/analytics/borrow-rank-per-user');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
curl_setopt($ch, CURLOPT_HTTPHEADER, [
    'Authorization: Bearer ' . $accessToken
]);
